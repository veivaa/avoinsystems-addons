...
class TestBankBarcode(common.TransactionCase):
    ...
    inputs = [
        ...
        ({
            # ref_number just long enough
            'iban': 'FI9657202320053452',
            'amount': 384.70,
            'ref_number': '20981958478930298394',
            'date': '2016-06-01',
        },'496572023200534520003847000020981958478930298394160601'),
        ({
            # ref_number just short enough
        ...
        ({
            ...
            'amount': 384.70,
            'ref_number': '1092878509387829382910293',
            'date': '2016-06-01',
        }, False),
        ({
            # RF ref_number just short enough
            'iban': 'FI2350000110000237',
            'amount': 30.00,
            'ref_number': 'RF12389179829012211567802',
            'date': '2016-06-09',
        }, '523500001100002370000300012389179829012211567802160609'),
        ({
            # RF ref_number just long enough
        ...
        ({
            # RF ref_number too long
            'iban': 'FI2350000110000235',
            'amount': 30.00,
            'ref_number': 'RF123891798290122115678202',
            'date': '2016-06-09',
        }, False),
        ({
            # RF ref_number too short
    ...
    def _create_invoice(self, invoice_fields):
        ...
        inv = self.env['account.move'].with_context(test_bank_barcode=True).create({
            ...
            'partner_id': self.partner.id,
            'ref_number': invoice_fields['ref_number'],
